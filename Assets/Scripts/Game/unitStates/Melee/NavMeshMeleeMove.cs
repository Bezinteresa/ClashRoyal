...
[CreateAssetMenu(fileName = "NavMeshMeleeMove", menuName = "UnitState/NavMeshMeleeMove")]
public class NavMeshMeleeMove : UnitStateNavMeshMove
{
    ...
    private bool TryChaseUnit()
    {
        ...
        bool hasEnemy = _mapInfo.TryGetNearestWalkingUnit(_unit.transform.position, _targetIsEnemy, out Unit enemy, out float distance);
